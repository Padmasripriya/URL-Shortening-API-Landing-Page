    ...
    return(
        <div className="footer-component py-5">
            <div className="container">
                <div className="row">
                    <div className="col-12 col-lg-5 footer-logo mb-5 pt-5">
                        <img src={FooterLogo} alt="footer logo" />
                    </div>
                    <div className="col-12 col-lg-5 company-features">
                        <ul className="mb-4">
                    ...
                    <div className="col-12 col-lg-5 company-resources">
                        <ul className="mb-4">
                    ...
                    <div className="col-12 col-lg-5 company-details">
                        <ul className="mb-4">
                    ...
                    <div class="col-12 col-lg-5 social-links">
